...
- [x] **Home**, **Vídeos**, **Notícias** abrem
- [x] **Notícias** → **Sugerir pauta** abre o modal
- [x] Avatar → **Meu Perfil** abre o perfil
- [ ] Avatar → **Sair** desloga
...
- [x] No perfil: **Artigos → Colaborar com artigos** some
...
- [x] `/colaboradores/artigos/dashboard` → toast **Escritor**
- [x] `/colaboradores/artigos/cadastrar` → toast **Escritor**
- [x] `/colaboradores/admin/dashboard` → toast **Administrador**
